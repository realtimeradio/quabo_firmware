...
#define FLASH_READ_ID 0x90 //wei ori:0x9e
...
#define FLASH_READ_REG 0x65
#define FLASH_WRITE_REG 0x71
// Program Operations
...
int flash_read_uid(uint8_t *p);
int flash_read_reg(uint32_t addr, uint8_t *p);
int flash_write_reg(uint32_t addr, uint8_t *p);
#endif // _FLASH_H_
