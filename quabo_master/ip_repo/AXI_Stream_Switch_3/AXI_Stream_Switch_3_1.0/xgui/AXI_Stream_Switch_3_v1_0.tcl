...
proc init_gui { IPINST } {
  ...
  set C_M0_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_M0_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of S_AXIS address bus. The slave accepts the read and write addresses of width C_M_AXIS_TDATA_WIDTH.} ${C_M0_AXIS_TDATA_WIDTH}
  set C_M0_AXIS_START_COUNT [ipgui::add_param $IPINST -name "C_M0_AXIS_START_COUNT" -parent ${Page_0}]
  set_property tooltip {Start count is the number of clock cycles the master will wait before initiating/issuing any transaction.} ${C_M0_AXIS_START_COUNT}
  set C_S0_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_S0_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {AXI4Stream sink: Data Width} ${C_S0_AXIS_TDATA_WIDTH}
  set C_S2_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_S2_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {AXI4Stream sink: Data Width} ${C_S2_AXIS_TDATA_WIDTH}
  set C_S1_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_S1_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {AXI4Stream sink: Data Width} ${C_S1_AXIS_TDATA_WIDTH}
