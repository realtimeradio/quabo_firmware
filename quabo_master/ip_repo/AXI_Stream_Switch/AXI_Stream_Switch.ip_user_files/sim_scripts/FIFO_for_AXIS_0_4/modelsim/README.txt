...
#
# Generated by export_simulation on Sun Oct 13 16:16:43 PDT 2019
#
################################################################################
...
'-reset_run' switch to the './FIFO_for_AXIS_0.sh' script.

./FIFO_for_AXIS_0.sh -reset_run
...
./FIFO_for_AXIS_0.sh -noclean_files

For more information on the script, please type './FIFO_for_AXIS_0.sh -help'.
