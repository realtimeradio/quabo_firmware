...
HD_PWD='/media/wei/DATA/LW/Project/Vivado_Project/IP_Cores_PanoSETI/AXI_Stream_Switch/AXI_Stream_Switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Stream_Switch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Stream_Switch.tcl
