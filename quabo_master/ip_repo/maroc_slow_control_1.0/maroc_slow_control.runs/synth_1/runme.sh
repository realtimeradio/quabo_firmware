...
HD_PWD='C:/XilinxProjects/PANOSETI/QuadrantBoard/ip_repo/maroc_slow_control_1.0/maroc_slow_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maroc_slow_control_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maroc_slow_control_v1_0.tcl
