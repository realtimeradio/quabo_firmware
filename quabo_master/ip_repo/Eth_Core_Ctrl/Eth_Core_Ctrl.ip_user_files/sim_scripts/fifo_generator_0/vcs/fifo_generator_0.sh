...
#
# Generated by Vivado on Wed Oct 09 22:19:33 PDT 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../Eth_Core_Ctrl.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/media/wei/DATA/LW/Project/Vivado_Project/IP_Cores_PanoSETI/Eth_Core_Ctrl/Eth_Core_Ctrl.cache/compile_simlib/vcs"
  fi
